...
# sector_metric_weights (title-case keys, e.g. "Technology Services") was
# removed — it diverged silently from sec_sector_metric_weights and was not
# imported by any live pipeline code.  Use sec_sector_metric_weights below.
